...
<CodeSurfer
  ...
  dark={false}
  steps={[
    { lines: [7, 8, 16, 17], notes: "The appliction, most likely the same as the app manifest ✏️" },
    { range: [1, 2] },
...
<CodeSurfer
  ...
  dark={false}
  steps={[
    { lines: [27], notes: "Registering a service worker ✏️" },
  ]}
/>
...
<CodeSurfer
  ...
  dark={false}
  steps={[
    { lines: [106, 143], notes: " Service Worker Precache is a module for generating a service worker that precaches resources. ✏️" },
  ]}
/>
